...
`#file:../../.github/skills/phinx/scripts/phinx.sh rollback` / `#file:../../.github/skills/phinx/scripts/phinx.sh rollback -target=20260314101200`
`#file:../../../geokrety-website/website/db/tests-copy-schema-geokrety-to-tests.sh`
`#file:../../.github/skills/pgtap/scripts/pg_prove /home/kumy/GIT/geokrety-website/website/db/tests/test-XXX.sql` (replace XXX with the test number)
