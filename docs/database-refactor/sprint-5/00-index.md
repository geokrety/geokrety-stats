...
| ----- | -------------------------------------- | ---------------------------------------------------------- | ---- | ---------------------------------------------------------- | ------------------------------------------------------- |
| S5T01 | - - [Spec DBA task-S5T01.dba.md](task-S5T01.md#dba) | [task-S5T01.specification.md](task-S5T01.md#specification) | 5.1  | Create `stats.hourly_activity` table                       | `20260310500000_create_hourly_activity.php`             |
| S5T02 | - - [Spec DBA task-S5T02.dba.md](task-S5T02.md#dba) | [task-S5T02.specification.md](task-S5T02.md#specification) | 5.2  | Create `stats.country_pair_flows` table                    | `20260310500100_create_country_pair_flows.php`          |
| S5T03 | - - [Spec DBA task-S5T03.dba.md](task-S5T03.md#dba) | [task-S5T03.specification.md](task-S5T03.md#specification) | 5.3  | Create `stats.gk_milestone_events` table                   | `20260310500200_create_gk_milestone_events.php`         |
| S5T04 | - - [Spec DBA task-S5T04.dba.md](task-S5T04.md#dba) | [task-S5T04.specification.md](task-S5T04.md#specification) | 5.4  | Create `stats.first_finder_events` table                   | `20260310500300_create_first_finder_events.php`         |
| S5T05 | - - [Spec DBA task-S5T05.dba.md](task-S5T05.md#dba) | [task-S5T05.specification.md](task-S5T05.md#specification) | 5.5  | Create `gk_loves` activity trigger function + attach        | `20260310500400_create_gk_loves_counter_trigger.php`   |
| S5T06 | - - [Spec DBA task-S5T06.dba.md](task-S5T06.md#dba) | [task-S5T06.specification.md](task-S5T06.md#specification) | 5.6  | Create canonical points-event emission trigger              | `20260310500500_create_amqp_event_trigger.php`          |
| S5T07 | - - [Spec DBA task-S5T07.dba.md](task-S5T07.md#dba) | [task-S5T07.specification.md](task-S5T07.md#specification) | 5.7  | Create milestone detection trigger function + attach       | `20260310500600_create_milestone_trigger.php`           |
| S5T08 | - - [Spec DBA task-S5T08.dba.md](task-S5T08.md#dba) | [task-S5T08.specification.md](task-S5T08.md#specification) | 5.8  | Create first finder detection trigger function + attach    | `20260310500700_create_first_finder_trigger.php`        |
| S5T09 | - - [Spec DBA task-S5T09.dba.md](task-S5T09.md#dba) | [task-S5T09.specification.md](task-S5T09.md#specification) | 5.9  | Create batch aggregation functions (hourly, country-pair)  | `20260310500800_create_batch_aggregation_functions.php` |
| S5T10 | - - [Spec DBA task-S5T10.dba.md](task-S5T10.md#dba) | [task-S5T10.specification.md](task-S5T10.md#specification) | 5.10 | Create analytics indexes                                   | `20260310500900_create_analytics_indexes.php`           |
