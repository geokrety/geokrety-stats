        ...
        <table class="table table-hover table-sm align-middle border">
          <thead class="table-dark">
            <tr>
              ...
              <th title="GeoKret category type">Type</th>
              <th title="GeoKret owner">Owner</th>
              <th title="Current holder or cache status">Status</th>
              <th class="text-end" title="Total number of recorded moves">Moves</th>
              <th class="text-end" title="Number of distinct users who moved it">Users</th>
              <th class="text-end" title="Number of distinct countries visited">Countries</th>
              <th class="text-end" title="Total points generated by this GeoKret">Points</th>
              <th class="text-end" title="Current points multiplier applied to moves">×</th>
              <th class="text-end" title="Number of loves / favourites">❤️</th>
            </tr>
          </thead>
          <tbody>
            <tr v-for="(gk, idx) in geokrety" :key="gk.gk_id">
